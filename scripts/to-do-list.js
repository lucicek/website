...
const toDoList = [
  {
    name: '<div style="margin-right: 4px;">Navštívit</div> <a href="index.html"> vitek.soon.it</a>',
...
function renderToDoList(){
  ...
  toDoList.forEach((toDoObject, idex)=>{
    ...
    const html = `
      ...
      <div class="info">${dueDate}</div>
      <button class="js-remove-to-do-object-button remove-button">Odstranit</button>`;
    toDoListHTML += html;
  });
